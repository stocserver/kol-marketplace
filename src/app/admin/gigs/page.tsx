                ...
                <div className="flex-1">
                  <div className="flex items-center space-x-4 mb-4">
                    ...
                    {(gig.image_urls && gig.image_urls.length > 0) || gig.preview_image_url ? (
                      <div className="flex space-x-2">
                        {gig.image_urls && gig.image_urls.length > 0 ? (
                          gig.image_urls.slice(0, 3).map((url, index) => (
                            <div key={index} className="w-16 h-16 bg-gray-200 rounded-lg overflow-hidden flex-shrink-0 relative">
                              <Image
                                src={url}
                      ...
                      <div className="w-16 h-16 bg-gray-200 rounded-lg overflow-hidden flex-shrink-0 relative flex items-center justify-center">
                  ...
                  {(() => {
                    ...
                    return allImages.length > 0 ? (
                      <div className="space-y-4">
                        {/* Main Image Display */}
                        <div className="relative w-full overflow-hidden rounded-lg bg-gray-100 pb-[56.25%]">
                          <Image
                            ...
                            onError={(e) => {
                              ...
                              target.src = '/images/placeholder-gig.svg';
                            }}
                          />
                          ...
                          <div className="flex gap-2 overflow-x-auto">
                            {allImages.map((image, index) => (
                              <button
                                ...
                                className={`flex-shrink-0 w-16 h-16 rounded-md overflow-hidden border-2 relative transition-all ${
